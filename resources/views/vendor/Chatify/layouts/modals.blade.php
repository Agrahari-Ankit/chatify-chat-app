...
<div class="app-modal" data-name="remove-user">
    <div class="app-modal-container">
          <div class="app-modal-card" data-name="remove-user" data-modal='0'>
            <div class="app-modal-header">Are you sure you want to remove from this group?</div>
            <div class="app-modal-body">You can not undo this action</div>
            <div class="app-modal-footer">
                <a href="javascript:void(0)" class="app-btn cancel">Cancel</a>
                <a href="javascript:void(0)" class="app-btn a-btn-danger delete">Delete</a>
...
{{-- ---------------------- add user Group Chat Modal ---------------------- --}}
<div class="app-modal" data-name="add-group">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="add-group" data-modal='0'>
            <form id="addGroupFormm" action="{{ route('group-chat.update') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="app-modal-header">
                   Add Users 
                </div>
                <div class="app-modal-body"> 
                    {{-- <input type="text" name="channel_id" class="channel_id" id="channel_id"  value="{{ $channel_id }}"> --}}
                    <div class="form-control">
                        <label class="form-label" for="search">Select user(s) to the group</label>
                        <input class="form-input user-search" type="text" name="search" placeholder="Search"/>
                    </div>
                    ...
                    <div style="margin-top: 1rem; margin-bottom: 2rem">
                        <label class="form-label">Added Users</label>
                        <div class="added-userss app-scroll users-listt"></div>
                    </div>
                </div>
                <div class="app-modal-footer">
                    <a href="javascript:void(0)" class="app-btn cancel">Cancel</a>
          ...
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="app-modal-body">
                      ...
                      <div class="avatar av-l upload-avatar-preview chatify-d-flex"
                      style="background-image: url('{{ asset(Chatify::getUserWithAvatar(Auth::user())->avatar) }}');"
                      ></div>
                      <p class="upload-avatar-details"></p>
                      <label class="app-btn a-btn-primary update" style="background-color:{{$messengerColor}}">
                          Upload New
